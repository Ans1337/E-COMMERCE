    ...
    <body>
        <div>
           ...
           <div id="bannerImage">
               <div class="container">
                   ...
                   <div id="bannerContent">
                       <h1>Welcome</h1>
                       <p>Avail 40% Flat till July 2nd.</p>
           ...
           <footer class="footer"> 
               <div class="container">
               <center>
                   <p>Copyright &copy <a href="index.php">E-Commerce</a> Store. All Rights Reserved.</p>
                   <p>This website is developed by Ans,Sehrish and Zonish</p>
               </center>
               </div>
           </footer>
        </div>
